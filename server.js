...
const redirects = require('./ClientApp/router/301.json')
...
const template = fs.readFileSync(resolve('./ClientApp/assets/index.template.html'), 'utf-8')
...
app.use(favicon('./ClientApp/static/favicon.ico'))
app.use('/example-source', serve('./ClientApp/examples', true)) // TODO: This should be a regex to serve anything with an extension
app.use('/static/manifest.json', serve('./manifest.json', true))
app.use('/static', serve('./ClientApp/static', true))
app.use('/dist', serve('./wwwroot/dist', true))
app.use('/static/robots.txt', serve('./robots.txt'))
app.use('/releases', serve('./ClientApp/releases'))
app.use('/themes', serve('./ClientApp/themes'))
